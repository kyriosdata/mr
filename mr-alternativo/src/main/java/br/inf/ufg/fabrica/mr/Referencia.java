...
//TODO: alterar long para 9
//e reduzir float e double caso os testes mostrem
...
public class Referencia {
     ...
     * 1, 2, 3 ou 5, respectivamente as sequências
     * 00, 01, 10 e 11, em binários. Devido ao "desperdício"
     * dos dois primeiros bits, um inteiro de 2^32 bits
     * requisita 5 bytes de informação e não somente 4.
     * <p/>
    ...
    public int nextInt(ByteArrayInputStream buf) {
        ...
        switch (i) {
            ...
            case 5:
                byte[] temp3 = {ini, (byte) buf.read(), (byte) buf.read(),
